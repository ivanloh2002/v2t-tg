...
Я использую ноутбук с RTX3070ti на 8 гигов VRAM. Он переводил сообщение **длиной в 7 минут за 44 секунды** (На модели *medium*) (я считал по логам aiograma). А на модели *large-v3-turbo* Это же гс у меня обработалось за 30 секунд. Это, если что,   время полного цикла, т.е расшифровка + дороботка.
